...
import type { CreateFoodPayload } from '~/stores/food'
...
<template>
  <div class="p-4 space-y-4">
    ...
    <header class="space-y-1">
      <h1 class="text-xl font-bold text-gray-800">افزودن غذا</h1>
      <p v-if="draftSaved" class="text-xs text-emerald-600">
        پیش‌نویس ذخیره شد
      </p>
    </header>
