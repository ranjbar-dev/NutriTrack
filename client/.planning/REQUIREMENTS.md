...
- [ ] **CLNT-01**: Client can open a Today view that surfaces the active plan, pending daily actions, water target, and sync status.
- [ ] **CLNT-02**: Client can view the full active diet plan with readable days, meals, options, exercise recommendations, prescriptions, and notes.
- [ ] **CLNT-03**: Client can view archived or historical plan information made available by the API without losing context of the active plan.

### Tracking

- [ ] **TRCK-01**: Client can log food intake against the documented tracking API with mobile-friendly entry flows.
- [ ] **TRCK-02**: Client can log water intake, sleep, exercise, medication intake, and body measurements from the mobile UI.
- [ ] **TRCK-03**: Client can review recent tracking history and lightweight progress summaries for the tracked data available in v1.

### Offline and Sync

- [ ] **OFFL-01**: Client can read the active plan and essential recent client data while offline.
- [ ] **OFFL-02**: Client write actions for supported tracking flows are queued locally with durable local IDs and visible sync states.
- [ ] **OFFL-03**: Client can see when queued entries are synced, retrying, or failed, and the app retries sync on reconnect or manual retry.

### Messaging and Notifications

- [ ] **MSG-01**: Client and nutritionist can read their conversation history with unread state and stable polling behavior.
- [ ] **MSG-02**: Client and nutritionist can send text messages and supported file attachments from mobile screens.
- [ ] **NOTF-01**: Authenticated user can subscribe or unsubscribe from push notifications on supported devices.
- [ ] **NOTF-02**: Authenticated user can view and update notification preferences for supported reminder and message categories.

### Nutritionist Workspace

- [ ] **NUTR-01**: Nutritionist can browse, search, and filter their client roster from a mobile-friendly workspace.
- [ ] **NUTR-02**: Nutritionist can open a client profile that shows identity details, current plan summary, tracking history, messages, lab results, and archived plans.
- [ ] **NUTR-03**: Nutritionist can create, edit, and manage a client's diet plan period and metadata.
- [ ] **NUTR-04**: Nutritionist can manage plan days, meals, meal options, meal items, exercises, and prescriptions from the frontend.

### Catalogue and Requests

- [ ] **CAT-01**: Nutritionist and eligible users can search and view foods and categories needed for plan authoring and client workflows.
- [ ] **CAT-02**: Nutritionist and eligible users can search and view medications needed for plan authoring and medication workflows.
- [ ] **CAT-03**: Client can submit a food request and nutritionist can review, approve, or reject food requests from the frontend.

### Lab Results

- [ ] **LAB-01**: Client and nutritionist can upload, view, and access lab results using the documented file or link-based flows.

### Super Admin

- [ ] **ADMIN-01**: Super admin can view platform stats and manage nutritionist accounts from mobile-compatible admin screens.
- [ ] **ADMIN-02**: Super admin can manage shared food and medication catalogues with the elevated admin endpoints.
