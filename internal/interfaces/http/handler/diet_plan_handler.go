...
func (h *DietPlanHandler) CreatePlan(c *gin.Context) {
	...
	dto.Created(c, appDietPlan.MapDietPlan(plan))
...
func (h *DietPlanHandler) ListClientPlans(c *gin.Context) {
	...
	for i, p := range plans {
		result[i] = appDietPlan.MapDietPlan(p)
	}
...
func (h *DietPlanHandler) GetPlan(c *gin.Context) {
	...
	dto.OK(c, appDietPlan.MapDietPlanFull(plan))
}
...
func (h *DietPlanHandler) UpdatePlan(c *gin.Context) {
	...
	dto.OK(c, appDietPlan.MapDietPlan(plan))
}
